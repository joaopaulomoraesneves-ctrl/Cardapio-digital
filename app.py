...
async def download_stream(
    ...
    # Direct redirect mode for maximum native browser download speed from CDN
    if mode == "redirect":
        return RedirectResponse(url=download_target_url, status_code=307)
